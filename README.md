...
│ _high_speed     │ │                 │ │                      │
│ · 循线 PD       │ │ · 球位置 PID    │ │ · 电机速度 PI        │
│ · 四通道全黑停车│ │ · 加速度前馈    │ │ · BLE 指令分发       │
│ · PI主动刹车     │ │ · 定点状态机    │ │ · 扫频/直驱          │
└────────┬────────┘ └───────┬─────────┘ └──────────┬───────────┘
         │                  │                      │
         ▼                  ▼                      ▼
...
| 模块 | 文件 | 职责 |
|------|------|------|
| 步进电机驱动 | `bsp/bsp_stepper.c/h` | STEP/DIR 脉冲输出，位置追踪 |
| K230 串口 | `bsp/bsp_uart2.c/h` | K230 专用 DMA 串口接收 |
| K230 协议解析 | `middleware/mid_k230.c/h` | 帧解析，钢球坐标提取 |
